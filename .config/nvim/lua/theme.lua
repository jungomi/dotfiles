...
local theme = {
  ...
  dap = {
    ...
    DapUIPlayPauseNC = { fg = colours.green },
    DapUIRestart = { fg = colours.green },
    DapUIRestartNC = { fg = colours.green },
    DapUIStepBack = { fg = colours.blue },
    DapUIStepBackNC = { fg = colours.blue },
    DapUIStepInto = { fg = colours.blue },
    DapUIStepIntoNC = { fg = colours.blue },
    DapUIStepOut = { fg = colours.blue },
    DapUIStepOutNC = { fg = colours.blue },
    DapUIStepOver = { fg = colours.blue },
    DapUIStepOverNC = { fg = colours.blue },
    DapUIStop = { fg = colours.red },
    DapUIStopNC = { fg = colours.red },
    DapUIUnavailable = { fg = colours.grey },
    DapUIUnavailableNC = { fg = colours.grey },
